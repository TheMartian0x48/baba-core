...
//     std::string medium_msg = "This is a medium length message for benchmarking logger performance
//     "
//                              "with typical message sizes";
//     for (auto _ : state) {
...
//         switch (counter % 4) {
//         case 0:
//             Logger::instance().debug("Debug message " + std::to_string(counter));
//             break;
//         case 1:
//             Logger::instance().info("Info message " + std::to_string(counter));
//             break;
//         case 2:
//             Logger::instance().warn("Warning message " + std::to_string(counter));
//             break;
//         case 3:
//             Logger::instance().error("Error message " + std::to_string(counter));
//             break;
//         }
//         counter++;
//     }
