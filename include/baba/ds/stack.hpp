...
template<typename T, size_t Alignment>
T& stack<T, Alignment>::top() {
    return data_[size_ - 1];
}

template<typename T, size_t Alignment>
const T& stack<T, Alignment>::top() const {
    return data_[size_ - 1];
}

template<typename T, size_t Alignment>
bool stack<T, Alignment>::empty() const noexcept {
    return size_ == 0;
}

template<typename T, size_t Alignment>
size_t stack<T, Alignment>::size() const noexcept {
    return size_;
}

template<typename T, size_t Alignment>
size_t stack<T, Alignment>::capacity() const noexcept {
    return capacity_;
}

template<typename T, size_t Alignment>
void stack<T, Alignment>::push(const T& item) {
    if (size_ >= capacity_) {
        grow();
    }
...
template<typename T, size_t Alignment>
void stack<T, Alignment>::push(T&& item) {
    if (size_ >= capacity_) {
        grow();
    }
...
template<typename T, size_t Alignment>
void stack<T, Alignment>::clear() noexcept {
...
template<typename T, size_t Alignment>
void stack<T, Alignment>::reserve(size_t new_capacity) {
