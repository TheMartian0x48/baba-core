...
template <u8 Alignment = 16>
String<Alignment> make(u32 capacity) {
    String<Alignment> str;
    str.data = baba::core ::aligned_alloc(capacity, Alignment);
    str.size = 0;
...
template <u8 Alignment = 16>
void free(String<Alignment> &str) {
    if (str.data) {
        baba::core::aligned_free(str.data);
        str.data = nullptr;
    }
    str.size = 0;
    str.capacity = 0;
